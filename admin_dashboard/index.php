...
<body>
    ...
    <div class="lk">
        <div class="left-bar">
            ...
            <a href="./users_data/" class="admin-btn">Управление <br>данными пользователей</a>
        ...
        <div class="right-bar">
            <p
                style='display: flex; align-items: center; justify-content: center; align-content: center; flex-wrap: nowrap; height: 60%;'>
